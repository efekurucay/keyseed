...
PACKAGE_DIR="$DIST_DIR/keyseed-v$VERSION-$OS-$ARCH"
ARCHIVE_NAME="keyseed-v$VERSION-$OS-$ARCH.tar.gz"
...
tar -czf "$DIST_DIR/$ARCHIVE_NAME" -C "$DIST_DIR" "keyseed-v$VERSION-$OS-$ARCH"
